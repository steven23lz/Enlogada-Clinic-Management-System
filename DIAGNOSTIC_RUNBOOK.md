...
cd frontend && npx playwright test                  # expect: 421 pass, 0 skipped
```
...
| Playwright E2E | **421 passed**, **0 skipped** (run with `--timeout=90000`, see §0) |
...
*Baseline recorded 2026-09-15, at the `[1.80.0]` commit. Re-measure and update the numbers in §1 whenever the suite
