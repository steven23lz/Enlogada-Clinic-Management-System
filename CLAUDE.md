...
cd frontend && npm run test:unit # 90 unit tests, vitest, ~1.5s
cd frontend && npm test        # 421 Playwright E2E, ~11m, needs both dev servers
```
