...
router.post('/providers', verifyToken, authorizeRoles('SuperAdmin', 'Admin'), authorizePermissions('hmo:approve'), hmoController.createProvider);
router.put('/providers/:id', verifyToken, authorizeRoles('SuperAdmin', 'Admin'), authorizePermissions('hmo:approve'), hmoController.updateProvider);
...
router.get('/requests', verifyToken, authorizeRoles('SuperAdmin', 'Admin', 'Receptionist', 'Cashier'), authorizePermissions('hmo:read'), hmoController.getAllRequests);

// Create an HMO request (Receptionist logs the manual HMO verification)
router.post('/request', verifyToken, authorizeRoles('SuperAdmin', 'Admin', 'Receptionist'), authorizePermissions('hmo:request'), hmoController.createRequest);
...
router.put('/request/:id/approve', verifyToken, authorizeRoles('SuperAdmin', 'Admin'), authorizePermissions('hmo:approve'), hmoController.approveRequest);

// Get HMO request details including linked tests
router.get('/request/:id', verifyToken, authorizeRoles('SuperAdmin', 'Admin', 'Receptionist', 'Cashier'), authorizePermissions('hmo:read'), hmoController.getRequestDetails);

// Update individual test approval status within an HMO request
router.put('/request-test/:hmoRequestTestId', verifyToken, authorizeRoles('SuperAdmin', 'Admin'), authorizePermissions('hmo:approve'), hmoController.updateTestApproval);
