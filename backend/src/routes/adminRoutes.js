...
router.get('/staff', verifyToken, authorizeRoles('SuperAdmin', 'Admin'), authorizePermissions('staff:manage'), adminController.getStaff);
router.post('/staff', verifyToken, authorizeRoles('SuperAdmin', 'Admin'), authorizePermissions('staff:manage'), adminController.createStaff);
router.patch('/staff/:id/status', verifyToken, authorizeRoles('SuperAdmin', 'Admin'), authorizePermissions('staff:manage'), adminController.updateStaffStatus);
...
router.patch('/staff/:id', verifyToken, authorizeRoles('SuperAdmin', 'Admin'), authorizePermissions('staff:manage'), adminController.updateStaffDetails);
...
router.patch('/staff/:id/password', verifyToken, authorizeRoles('SuperAdmin', 'Admin'), authorizePermissions('staff:manage'), adminController.resetStaffPassword);
