      ...
      <div className="flex items-center space-x-8">
        ...
        {user ? (
          <div className="flex items-center space-x-3">
            ...
            <button
              onClick={logout}
              className="bg-primary-hover hover:bg-primary-active text-white px-4 py-1.5 rounded-lg text-xs font-semibold flex items-center space-x-1.5 border-0 cursor-pointer shadow-xs transition-colors"
            >
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className="bg-primary-hover hover:bg-primary-active text-white px-4 py-2 rounded-lg text-xs font-semibold border-0 cursor-pointer shadow-xs transition-colors"
            >
              Create Account
            </button>
          </div>
