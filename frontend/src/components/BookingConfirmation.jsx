...
const BookingConfirmation = ({ referenceCode, queueNumber, patientName, scheduledDate, scheduledTime, onClose }) => {
  return (
    <div className="space-y-5">
      ...
      <div className="print-area space-y-4 bg-white rounded-2xl border border-[#e6ebf1] p-5 text-center">
        ...
        <div className="grid grid-cols-2 gap-3 pt-3 border-t border-[#e6ebf1]">
          <div className="space-y-0.5">
